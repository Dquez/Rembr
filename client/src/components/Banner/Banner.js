  ...
  render () {
    ...
    return (
      <div className="banner">
        ...
        <a href="https://chrome.google.com/webstore/detail/rembr/mpbdabjachklldenkpdnpnhbnhoebnnm" rel="noopener noreferrer" target="_blank"><button className="btn btn-success" style={{display:"inline"}}>Add Rembr to Chrome </button></a>
